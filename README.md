...
[![RetroArch Version](https://img.shields.io/badge/RetroArch-v1.7.2-brightgreen?style=flat-square)](#)
[![NextUI Version](https://img.shields.io/badge/NextUI-v1.7.2-brightgreen?style=flat-square)](#)
...
> [!IMPORTANT]
> ### v1.7.2 Update
> Both the RetroArch and NextUI versions have been upgraded to **v1.7.2**.
...
> * **NextUI Update:** The NextUI version has been upgraded to **v1.7.2**, adding Gap / Grid Color, Gap / Grid Color Intensity, Grid width rename, and removal of Dot brightness compensation to match the RetroArch version.
...
| :--- | :---: | :--- | :--- |
| **Standard** | **v1.7.2** | RetroArch (`gl` / `glcore`) | Optimized for low-power devices, with optional advanced display simulation (Grid / LCD Dot / CRT Phosphor). |
| **NextUI** | **v1.7.2** | NextUI / minarch | Optimized for TrimUI Brick and similar low-power handhelds (Grid and LCD Dot). CRT Phosphor excluded for performance. |
...
*PT SkyWalker541 by SkyWalker541 | RetroArch v1.7.2 | NextUI v1.7.2 | AI assisted development*
